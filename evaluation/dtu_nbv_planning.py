...
def main():
    ...
    if args.planning_only:
        ...
        assert os.path.exists(experiment_path), "experiment path does not exist!"
        ...
        total_df.to_csv(f"{experiment_path}/experiment_dtu.csv")
...
def planning_args(parser):
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="path to nbv planning experiment, needed in evaluation_only mode",
    )
    parser.add_argument(
        "--planning_only",
        action="store_true",
        help="planning only without evaluation",
    )

    parser.add_argument(
        "--evaluation_only",
        action="store_true",
        help="evaluation only after planning experiment",
    )
    return parser
